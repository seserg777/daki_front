...
export class ProductsComponent implements OnDestroy, OnInit  {
  ...
  public changeSort(event: HTMLInputEvent) {
    const value: string = event.target.value === '' ? 'id' : event.target.value;
  ...
  public addWishlist(product: ProductModel, event: HTMLInputEvent) {
