...
export class FilterComponent implements OnDestroy {
    ...
    public varsPriceFrom: string | null = '0';
    public varsPriceTo: string | null = '-1';
    ...
    public priceFrom(event: MouseEvent) {
        const target: HTMLElement | null = event.target as HTMLInputElement;
        this.varsPriceFrom = target.nodeValue === '' ? '0' : target.nodeValue;
    ...
    public priceTo(event: MouseEvent) {
        const target: HTMLElement | null = event.target as HTMLInputElement;
        this.varsPriceTo = target.nodeValue === '' ? '0' : target.nodeValue;
    ...
    public onManufacturerChange(event: MouseEvent) {
